...
import { SimonDice } from '../../clases/simon-dice';
...
export class SimonDiceComponent implements OnInit {
  ...
  guardar(){
    ...
    this.dataService.savePuntaje('simondice', this.user, this.contador)//updatePuntaje(this.user.uid, this.user.puntajes)
      .then(() => {
